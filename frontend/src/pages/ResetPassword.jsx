        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            <div className="text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{t('resetPassword.success.title')}</h2>
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            <div className="text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{t('resetPassword.invalidLink.title', 'Invalid reset link')}</h2>
              <p className="text-sm sm:text-base text-gray-500 mt-3">
                {t('resetPassword.invalidLink.message', 'This password reset link is invalid or has expired.')}
              </p>
              <Link
                to="/forgot-password"
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">{t('resetPassword.title', 'Set new password')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            >
              {loading ? t('resetPassword.resetting', 'Resetting...') : t('resetPassword.submit', 'Reset password')}
            </button>
          </form>
